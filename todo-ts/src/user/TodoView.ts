...
<div class="col-pp-100 col-pl-50 col-tl-33" v-pager="pager">
  <ul class="ui right floated horizontal list">
    <li class="item" title="sort">
      <button class="stripped" v-disable="2 > pager.size || (pager.state & ${PagerState.LOADING})"
    ...
    <li class="item" title="refresh">
      <button class="stripped" v-disable="(pager.state & ${PagerState.MASK_RPC_DISABLE}) || pager.size === 0"
          @click.prevent="pager.store.reload()">
        <i class="icon cw"></i>
      </button>
    </li>
    <li class="item">
      <button class="stripped" v-disable="(pager.state & ${PagerState.LOADING}) || pager.page === 0"
          @click.prevent="pager.store.repaint((pager.page = 0))">
        <i class="icon angle-double-left"></i>
      </button>
    </li>
    <li class="item">
      <button class="stripped" v-disable="(pager.state & ${PagerState.MASK_RPC_DISABLE})"
    ...
    <li class="item">
      <button class="stripped" v-disable="(pager.state & ${PagerState.LOADING}) || pager.page === pager.page_count"
  ...
  <ul class="ui horizontal list">
    <li class="item page-info" v-show="pager.size">
